...
def get_sheets_small_data(datapath):
    """
    Get the first five rows of a datasheet
    
    Parameters:
    ----------
    datapath : str
        A string path to your dataframe
        
    Returns:
    ----------
    pandas.DataFrame
        The first five rows of a datasheet
...
def construct_result_table(tables_list, file_name, color_cells=True,make_pivot_with_strata=False,  sort_by_total=False, conditional_formating=True):
